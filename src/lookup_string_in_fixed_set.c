...
#  define LIBHSTS_HIDDEN __attribute__ ((visibility ("hidden")))
#else
#  define LIBHSTS_HIDDEN
#endif
 ...
 * Automaton) by the script hsts-make-dafsa during compilation. This permits
 * efficient (in time and space) lookup. The graph generated by hsts-make-dafsa
 ...
 *
 * Lookup a domain key in a byte array generated by hsts-make-dafsa.
 */

/* prototype to skip warning with -Wmissing-prototypes */
int LIBHSTS_HIDDEN LookupStringInFixedSet(const unsigned char*, size_t,const char*, size_t);

int LIBHSTS_HIDDEN LookupStringInFixedSet(const unsigned char* graph,
	size_t length,
	const char* key,
	size_t key_length)
{
...
/* prototype to skip warning with -Wmissing-prototypes */
int LIBHSTS_HIDDEN GetUtfMode(const unsigned char *graph, size_t length);
